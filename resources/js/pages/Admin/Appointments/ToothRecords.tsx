...
const AdminAppointmentToothRecordsPage = ({ appointmentId }: { appointmentId: string }) => {
    ...
    const fetchAppointmentAndServices = async () => {
        try {
            ...
            const appointmentRes = await apiAdmin.getAppointment(parseInt(appointmentId));
    ...
    const handleSave = async () => {
        try {
            ...
            await apiAdmin.checkInAppointment(parseInt(appointmentId));
...
export default AdminAppointmentToothRecordsPage;
