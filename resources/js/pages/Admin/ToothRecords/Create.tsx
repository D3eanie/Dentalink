...
export default function AdminToothRecordsCreatePage() {
    ...
    const fetchInitialData = async () => {
        try {
            ...
            const appointmentsRes = await apiAdmin.getAppointments({ per_page: 100 });
    ...
    const handleSave = async () => {
        try {
            ...
            window.location.href = '/admin/tooth-records';
        } catch (error: any) {
